...
public class MagParticleSystemHandler : MonoBehaviour {

    public static MagParticleSystemHandler Instance { get; private set; }
    ...
    public void SpawnMag(Vector3 position, Vector3 direction) {
        singleList.Add(new Single(position, direction, meshParticleSystem));
    }


    /*
     * Represents a single Mag
     * */
