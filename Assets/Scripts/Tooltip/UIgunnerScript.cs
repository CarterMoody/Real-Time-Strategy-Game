...
public class UIgunnerScript : MonoBehaviour
{
    ...
    void OnMouseDown()
    {
        //TooltipTop.ShowTooltipTop_Static("test");
         if (PointBank.subtractPoints_Static(0))
        {
            TooltipTop.ShowTooltipTop_Static("Spawning 1 gunner");
            US_Spawner.spawnTroops_Static(Unit_US.Unit_USType.Gunner);
        } 
